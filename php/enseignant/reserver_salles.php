...
<html lang="fr">
    ...
    <body>
        ...
        <div class="a4-container">
            <h2>Formulaire de réservation de salle</h2>

            <form action="../formulaire/reservation_salles_handler.php" method="POST">

                <div class="consignes">
                    <p>
                    Informations de l’étudiant référent,
                    qui se chargera de récupérer et de remettre 
                    les clés de la salle à l'accueil.
                    Il est tenu responsable de la salle.
                    En quittant cette dernière, il doit 
                    s’assurer qu’elle est laissée en bon état,
                    et de bien fermer la porte à clé.
                    </p>
                </div>
                ...
                <table>
                    ...
                    <tr><td>Salle à réserver</td><td><input type="text" name="salle" required></td></tr>
                    <tr><td>Date de réservation</td><td><input type="date" name="date_reservation" style="width:100%" required></td></tr>
                    ...
                    <tr>
                        <td>Heure de fin (jusqu'à 18h00)
                            <p class="note">
                                Merci de respecter l'horaire afin de garantir le bon usage de la salle pour tous.
                            </p>
                        </td>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <p class="note">
                                Seules les personnes listées ici peuvent avoir accès à la salle.
                            </p>
                        </td>
