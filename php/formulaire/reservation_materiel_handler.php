...
$stmt = $conn->prepare("INSERT INTO reservations_materiel (nom, prenom, num_etudiant, adresse_email, groupe_tp, materiel, date_reservation, heure_debut, heure_fin, motif, participants, commentaires, signature) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
